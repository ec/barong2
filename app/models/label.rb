...
class Label < ApplicationRecord
    ...
    scope :kept, -> { joins(:user).where(accounts: { discarded_at: nil }) }
  ...
  # Indexes
  #
  #  index_labels_on_account_id                    (user_id)
  #  index_labels_on_key_and_scope_and_account_id  (key,scope,user_id) UNIQUE
  #
  # Foreign Keys
  #
  #  fk_rails_c02659cdf4  (user_id => accounts.id) ON DELETE => cascade
  #
